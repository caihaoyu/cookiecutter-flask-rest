...
# from {{cookiecutter.project_slug}} import app, rest_api, jwt
# from {{cookiecutter.project_slug}}.common import util
# from {{cookiecutter.project_slug}}.api.base import BaseAPI
# from {{cookiecutter.project_slug}}.model.user import User
# from {{cookiecutter.project_slug}}.service.user import rule_required, get_current_user
# from {{cookiecutter.project_slug}}.service.user import save_new_user, update_user
